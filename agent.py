...
class Agent:
    def __init__(self, input_dims, alpha=0.001, beta=0.002, env=None, gamma=0.99,
                 n_actions=2, max_size=1000000, tau=0.05, batch_size=64, noise=0.1):
        self.gamma = gamma
        self.tau = tau
        ...
        self.critic = CriticNet(name='critic')
        self.target_actor = ActorNet(n_actions=n_actions, name='target_actor')
        self.target_critic = CriticNet(name='target_critic')
    ...
    def learn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            target = reward + self.gamma * target_critic_value * (1 - done)
            critic_loss = tf.losses.MSE(target, critic_value)
        ...
        self.update_network_parameters(0.05)
